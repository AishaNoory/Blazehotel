...
namespace BlazeHotelSystem {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string Username, string Email, string Phone, string Password) {
...
namespace BlazeHotelSystem.DataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Username], [Email], [Phone], [Password]) VALUES (" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [Username] = @Username, [Email] = @Email, [Phone] = " +
                "@Phone, [Password] = @Password WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["BlazeConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Email, Phone, Password FROM dbo.Customers";
        ...
        public virtual int Insert(string Username, string Email, string Phone, string Password) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Email, string Phone, string Password, int Original_Id) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
